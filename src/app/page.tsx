...
export default function HomePage() {
  return (
    <main className="min-dvh font-pretendard flex flex-col bg-white **:tracking-[-0.03em] dark:bg-black">
      <section className="hero sticky top-0 z-0 flex w-full flex-col items-center justify-center bg-[linear-gradient(220deg,#FFF9E5_20.84%,#D4FFFE_93.31%)] px-6 pt-20">
        {/* Hero Section */}
