...
export function FeaturedPostCard({ post }: FeaturedPostCardProps) {
  ...
  return (
    <Link
      href={`/community/${id}`}
      className="flex h-[204px] w-[260px] shrink-0 flex-col justify-between gap-4 rounded-[24px] bg-white px-6 py-4 shadow-[0px_0px_30px_0px_rgba(0,0,0,0.05)] md:h-[250px] md:w-[384px] md:gap-6 md:rounded-[32px] md:p-8"
    >
