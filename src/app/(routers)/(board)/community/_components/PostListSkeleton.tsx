...
function FeaturedPostCardSkeleton() {
  return (
    <div className="h-[204px] w-[260px] shrink-0 animate-pulse rounded-[24px] bg-gray-200 md:h-[250px] md:w-[384px] md:rounded-[32px]" />
  );
}
...
function PostListItemSkeleton() {
  return (
    <div className="flex w-full items-center gap-6 px-4 py-6 md:gap-8 [&:not(:last-child)]:border-b [&:not(:last-child)]:border-gray-300">
      ...
      <div className="size-[72px] shrink-0 animate-pulse rounded-[12px] bg-gray-200 md:size-[120px] md:rounded-[16px]" />
    </div>
  );
}
