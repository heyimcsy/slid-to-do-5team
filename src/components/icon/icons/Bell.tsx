...
type BellIconProps = SVGProps<SVGSVGElement> & {
  variant?: 'default' | 'orange';
};

export const BellIcon = ({ variant = 'default', ...props }: BellIconProps) => {
  return (
    <svg
      width="100%"
      height="100%"
    ...
    >
      ...
      />
      {variant === 'orange' && <circle cx="17.5" cy="4.5" r="3.5" fill="var(--color-orange-500)" />}
    </svg>
  );
};
