  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          'bg-background fixed z-50 flex flex-col bg-clip-padding px-5 pt-6 text-sm shadow-lg md:px-10 md:pt-10 lg:pt-12',
          ...
          'data-[side=left]:inset-y-0 data-[side=left]:left-0 data-[side=left]:h-full data-[side=left]:w-full data-[side=left]:border-r data-[side=left]:data-ending-style:translate-x-[-2.5rem] data-[side=left]:data-starting-style:translate-x-[-2.5rem]',
          'data-[side=right]:inset-y-0 data-[side=right]:right-0 data-[side=right]:h-full data-[side=right]:w-full data-[side=right]:min-w-83.75 data-[side=right]:data-ending-style:translate-x-[2.5rem] data-[side=right]:data-starting-style:translate-x-[2.5rem] lg:data-[side=right]:w-200 lg:data-[side=right]:rounded-l-2xl',
          className,
        )}
        {...props}
      >
          ...
          <SheetPrimitive.Close
            ...
            render={
              <Button
                variant="icon"
                size="none"
                className="absolute top-6 right-5 md:top-10 md:right-10 lg:top-12"
              />
            }
          >
            <Icon name="delete" />
